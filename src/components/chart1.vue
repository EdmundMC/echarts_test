...
export default {
  ...
  methods: {
    ...
    drawChart5() {
      let myChart = this.$echarts.init(this.$refs.sankey2, "vintage");
      let option = {
        title: {
          text: "热度桑基图",
          textStyle: {},
